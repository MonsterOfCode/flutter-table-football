  ...
  routes: [
    ...
    GoRoute(
      ...
      routes: [
        ...
        // Create Team View
        GoRoute(name: CreateTeamView.routeName, path: CreateTeamView.routeName, builder: (context, state) => CreateTeamView(isToReturn: state.extra as bool?)),
        ...
        // Create Game View
        GoRoute(name: CreatePlayerView.routeName, path: CreatePlayerView.routeName, builder: (context, state) => CreatePlayerView(isToReturn: state.extra as bool?)),
